...
export const DropdownHover1 = () => {
  ...
  return (
    <div className="dropdown mr-6 z-30">
      <button onClick={myFunction} className="dropbtn text-sm text-gray-500 dark:hover:text-white mb-2 cursor-pointer">English <i class="fa-solid fa-angle-down text-gray-500 transition-all text-xs"></i></button>
