                    ...
                    <div className='flex my-[100px]'>
                            ...
                            <div>
                                <div className='flex mt-10'>
                                    <div className='relative text-gray-500 mr-6'>
                                        ...
                                        <input type="text" className='border border-gray-300  px-10 py-5 rounded-md font-normal focus:outline-blue-400' />
                                    </div>
                                    <div className='relative text-gray-500 mr-6'>
                                    ...
                                    <div className='relative text-gray-500'>
                                        ...
                                        <input type="email" className='border border-gray-300  px-10 py-5 rounded-md font-normal focus:outline-blue-400' />
                                    </div>
                                </div>
                                ...
                                <div className='relative text-gray-500 mt-8'>
                                    ...
                                    <textarea className='resize-none border border-gray-300 rounded-md font-normal focus:outline-blue-400 
                                    px-9 py-5' cols="101" rows="5"></textarea>
                                </div>
                        ...
                        <div className='ml-10 text-gray-500'>
                            <div>
                                ...
                                <p className='mb-5 leading-8'>8212 E. Glen Creek Street Orchard Park, NY 14127, United <br/>States of America</p>
