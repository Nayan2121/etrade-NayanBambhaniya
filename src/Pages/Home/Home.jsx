    ...
    return (
        <>
            <div className='Body bg-white '>
                ...
                <section className='HOME-DROPDOWN py-2  container mx-auto'>
                ...
                <section className='HOME-NAVBAR sticky top-2 z-50 container mx-auto'>
                    <HomeNavBar />
                </section>

                <section className='HERO-SECTION bg-[#F9F3F0] -top-36 h-[110vh] relative overflow-hidden'>
                ...
                <section className='HOME-SERVICES  container mx-auto'>
                    <HomeService />
                </section>

                <section className='HOME-FOOTER  container mx-auto'>
                    <HomeHoverPhoto />
                    <SubscribePhoto />
                    <Footer />
                </section>
