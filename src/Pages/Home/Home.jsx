...
<section className='HOME-DROPDOWN py-2 px-72'>
...
<section className='HOME-NAVBAR sticky top-2 z-50 px-72'>
    <HomeNavBar />
</section>

<section className='HERO-SECTION bg-[#F9F3F0] -top-36 h-[120vh] relative overflow-hidden px-72'>
...
<section className='CATEGORIES px-72'>
...
<section className='HEADPHONES-PHOTO mb-[100px] px-72 '>
    <div className='relative w-full h-[500px] rounded-md bg-[#F6F7FB] '>
        <img className='absolute right-40 -top-24' src="./src/assets/home/asset 20.png" alt="" />
...
<section className='FEED-BACK'>
    <div className='bg-[#F9F3F0]  px-72 py-24'>
...
<section className='TRADE-STORE px-72'>
    <div>
        <div className='mt-14'>
        ...
        <div className='grid grid-cols-2 gap-8'>
            ...
            <div className='flex justify-between items-center border rounded-md p-7 group hover:shadow-lg hover:duration-500 hover:border-none duration-[0.9s]'>
                <div className='flex items-center '>
...
<section className='HOME-SERVICES px-72'>
    <HomeService />
</section>

<section className='HOME-FOOTER px-72'>
    <HomeHoverPhoto />
    <SubscribePhoto />
    <Footer />
</section>
