        ...
        <>
            <div>
                ...
                <section className='IMAGES-AND-DISCRIPTION  bg-[#F9F3F0]'>
                    <div className='grid grid-cols-2 gap-10 py-[100px]  container mx-auto '>
                            ...
                            <div>
                                ...
                                <div className='flex justify-between items-center'>
                                    <div className='flex items-center'>
                                        <span className='bg-gray-100 py-[4px] px-[12px] rounded-full cursor-pointer'>-</span>
                                        <h1 className='font-semibold text-lg mx-5'>1</h1>
                                        <span className='bg-gray-100 py-[4px] px-[10px] rounded-full cursor-pointer'>+</span>
                                    </div>
                                    <div className='flex items-center'>
                                        <div className='mx-5'>
